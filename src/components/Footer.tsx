        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-6 text-gray-400 leading-relaxed">
              Celebrating the rich textile heritage of India through contemporary designs that honor tradition and embrace modernity.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-medium mb-4 border-b border-gray-700 pb-2">Quick Links</h4>
          ...
          {/* Customer Service */}
          <div>
            <h4 className="text-white font-medium mb-4 border-b border-gray-700 pb-2">Customer Service</h4>
            <ul className="space-y-2">
              ...
              <li><Link href="/care-instructions" className="text-gray-400 hover:text-white">Care Instructions</Link></li>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white font-medium mb-4 border-b border-gray-700 pb-2">Contact Us</h4>
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin size={18} className="text-gold-400 mr-2 mt-1 flex-shrink-0" />
                <span>
